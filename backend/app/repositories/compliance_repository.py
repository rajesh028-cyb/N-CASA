...
class ComplianceRepository:
    ...
    async def save_compliance_results(self, audit_id: str, results_data: List[Dict[str, Any]]) -> List[ComplianceResultModel]:
        ...
        stmt = pg_insert(ComplianceResultModel).values(values_list)
        stmt = stmt.on_conflict_do_update(
            constraint="uq_audit_control",
            set_={
                ...
                "internal_mapping": stmt.excluded.internal_mapping,
